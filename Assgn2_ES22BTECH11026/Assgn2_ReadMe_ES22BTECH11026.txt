...
You should first enter the value of N(i.e the no. of rows in the matrix), then give a space, then enter the value of K(i.e the no. of threads), then a space, enter 12(i,e the no. of processors on my laptop), then the value of the no. of Bounded threads(BT).
